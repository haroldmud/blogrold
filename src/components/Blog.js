            ...
            {newsData?.map((item, idx) => (
              <div key={item.id} className="">
                <button
                  ...
                  key={idx}
                  className="flex justify-between  w-full border p-2 mx-auto hover:shadow"
                >
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-4 md:text-[10px]">
                      ...
                      <p className="bg-gray-300 md:block hidden px-2 text-gray-500 rounded-2xl my-auto">
                        {item.publishedAt
                          .split("")
                          .splice(0, item.publishedAt.length - 1)
                          .join("")
                          .split("T")
                          .join(" at ")}
                      </p>
                ...
                <div
                  className={`${
                    item.poppedUp ? "flex" : "hidden"
                  }  flex-col lg:justify-center  z-20 fixed color  w-full lg:h-[100vh] h-[100rem] top-0 left-0`}
                >
                  <div className="shadow md:w-6/12 w-11/12 h-fit pb-4 bg-white lg:mt-0 mt-32  mx-auto">
                    <div className="flex justify-end">
                      <button onClick={handleSwitch} className="p-4">
                        <VscChromeClose />
                      </button>
                    </div>
                    <div>
                      ...
                      <div className="flex flex-col gap-2 px-4">
                        ...
                        <h2 className="text-2xl leading-8 font-bold text-blue-900">
                          {item.title}
                        </h2>
                        ...
                        <div className="flex justify-start">
                          <a
                            ...
                            href={item.url}
                            target="_blank"
                            className="bg-blue-900 font-bold px-2 py-1 rounded-sm text-white "
                          >
                            LEARN MORE
                          </a>
                        </div>
